...
const MapsMarks = ({state, uid}) => {
  ...
  return (
    <Fragment>
      <Map back={MapsBack} second={state.items[1][6] || state.items[1][7] || state.items[1][8] || state.items[1][9] || state.items[1][10] ? true : false} />
      <Svg
        second={state.items[1][6] || state.items[1][7] || state.items[1][8] || state.items[1][9] || state.items[1][10] ? true : false}
