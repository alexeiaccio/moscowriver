    ...
    <Fragment>
      ...
      >
        <g id="Canvas" fill="none">
          {state.activeList === 1 &&
            <g id="maps_1">
              ...
              <g>
                ...
                <path id="mark_1b-1" fill-rule="evenodd" clip-rule="evenodd" d="M16 15.2857L19 11.2098C14.729 8.18922 9.38363 4.30087 3.54956 0L0 5C4.12146 7.32301 10.1971 11.2969 16 15.2857Z"
                ...
                <path id="mark_1b-7" fill-rule="evenodd" clip-rule="evenodd" d="M16 15.2857L19 11.2098C14.729 8.18922 9.38363 4.30087 3.54956 0L0 5C4.12146 7.32301 10.1971 11.2969 16 15.2857Z"
                  transform="translate(399 163)" fill="#F0C41B" />
                <path id="mark_1b-8" fill-rule="evenodd" clip-rule="evenodd" d="M16 15.2857L19 11.2098C14.729 8.18922 9.38363 4.30087 3.54956 0L0 5C4.12146 7.32301 10.1971 11.2969 16 15.2857Z"
                  transform="translate(329 100)" fill="#F0C41B" />
                <path id="mark_1b-9" fill-rule="evenodd" clip-rule="evenodd" d="M16 15.2857L19 11.2098C14.729 8.18922 9.38363 4.30087 3.54956 0L0 5C4.12146 7.32301 10.1971 11.2969 16 15.2857Z"
              ...
              <path id="mark_1-10" d="M464 82L379 182.25L382 183.5L466.5 84L464 82ZM248.5 0L235.5 92H241L253.5 0H248.5ZM0 114L62 104L63.5 108L0 118V114Z"
                transform="translate(59 72)" stroke="black" />
              <g id="mark_1-2">
                <circle id="Ellipse" cx="12.5" cy="12.5" r="12.5" transform="translate(510 271)" fill="black" />
                <text id="3" transform="translate(519.286 276.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">3</tspan>
                </text>
                <circle id="Ellipse_2" cx="12.5" cy="12.5" r="12.5" transform="translate(539 348)" fill="black" />
                <text id="3_2" transform="translate(548.286 353.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">3</tspan>
                </text>
              </g>
              <g id="mark_1-1">
                <circle id="Ellipse_3" cx="12.5" cy="12.5" r="12.5" transform="translate(550 377)" fill="black" />
                <text id="2" transform="translate(559.286 382.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">2</tspan>
                </text>
              </g>
              <g id="mark_1-3">
                <circle id="Ellipse_4" cx="12.5" cy="12.5" r="12.5" transform="translate(462 174)" fill="black" />
                <text id="4" transform="translate(471.286 179.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">4</tspan>
                </text>
              </g>
              <g id="mark_1-4">
                <circle id="Ellipse_5" cx="12.5" cy="12.5" r="12.5" transform="translate(389 170)" fill="black" />
                <text id="5" transform="translate(398.286 175.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">5</tspan>
                </text>
              </g>
              <g id="mark_1-5">
                <circle id="Ellipse_6" cx="12.5" cy="12.5" r="12.5" transform="translate(422 146)" fill="black" />
                <text id="6" transform="translate(431.286 151.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">6</tspan>
                </text>
              </g>
              <g id="mark_1-6">
                <circle id="Ellipse_7" cx="12.5" cy="12.5" r="12.5" transform="translate(393 127)" fill="black" />
                <text id="7" transform="translate(402.286 132.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">7</tspan>
                </text>
              </g>
              <g id="mark_1-7">
                <circle id="Ellipse_8" cx="12.5" cy="12.5" r="12.5" transform="translate(319 106)" fill="black" />
                <text id="8" transform="translate(328.286 111.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">8</tspan>
                </text>
              </g>
              <g id="mark_1-8">
                <circle id="Ellipse_9" cx="12.5" cy="12.5" r="12.5" transform="translate(207 45)" fill="black" />
                <text id="9" transform="translate(216.286 50.7139)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">9</tspan>
                </text>
              </g>
              <g id="mark_1-9">
                <circle id="Ellipse_10" cx="12.5" cy="12.5" r="12.5" transform="translate(95 63)" fill="black" />
                <text id="10" transform="translate(102 68.7139)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
                  <tspan x="0" y="11.24">10</tspan>
                </text>
              </g>
              <g id="mark_1-0">
                <circle id="Ellipse_11" cx="12.5" cy="12.5" r="12.5" transform="translate(568 423)" fill="black" />
                <text id="1" transform="translate(577.286 428.714)" fill="white" space="preserve" style="white-space: pre" fontFamily="Montserrat"
                  fontStyle="Medium" fontSize="11.4286" fontWeight="500" letterSpacing="0em">
          ...
          {state.activeList === 0 &&
            <g id="maps_0">
              <path id="mark-0-0" d="M8 0L0 3V7L4 14.5L8 28V36L11.5 41L22.5 36L8 0Z" transform="translate(584 418.5)" fill="#F05A5A" />
              <path id="mark-0-1" d="M5.5 11L0 2.5L5.5 0L7.5 2.5L12 4L43 85.5L35 88.5L31.5 80.5L27 54.5L23.5 49.5L17 31L10.5 23L5.5 11Z"
                transform="translate(549 333)" fill="#3095BF" />
              <path id="mark-0-2" d="M37.5 93.5L42.5 91.5C39.5 76.5 36 59.5 29.5 43.5C26.1034 35.1392 13.6667 10.6667 6.5 0L0 3.5C3.33333 9.16667 10.7 21.6 13.5 26C17 31.5 23.5 46 27 56C29.8 64 35.1667 84.3333 37.5 93.5Z"
                transform="translate(509.5 237)" fill="#C4549A" />
